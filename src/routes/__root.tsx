...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Weekly — Tasks & Objectives" },
      {
        name: "description",
        content:
          "A calm weekly planner for tasks and objectives. Plan your week, track progress, stay focused.",
      },
      { name: "author", content: "Weekly" },
      { property: "og:title", content: "Weekly — Tasks & Objectives" },
      {
        property: "og:description",
        content: "A calm weekly planner for tasks and objectives.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Weekly — Tasks & Objectives" },
